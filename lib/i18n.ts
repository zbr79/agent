...
export const STR: Record<UiLang, Record<string, string>> = {
  zh: {
    ...
    "nav.rename": "重命名",
    "nav.workspace": "Agent 工作目录",
    "nav.workspaceCopied": "已复制工作目录路径",
    "nav.pin": "置顶",
    "nav.unpin": "取消置顶",
    "nav.delete": "删除",
    ...
    "nav.guestHint": "暂无对话",
    "messages.loadEarlier": "加载更早的 {count} 条消息",
    ...
    "activity.failed": "失败",
    "activity.error": "失败",
    "activity.interrupted": "已中断",
    "activity.toggle": "工作日志",
    "activity.stepsCompleted": "{n} 项已完成",
    "activity.hideCompleted": "收起已完成",
    "activity.waiting": "等待工具调用…",
    "activity.completedClosed": "已完成（连接已关闭）",
    "activity.filesChanged": "已改文件",
  ...
  en: {
    ...
    "nav.workspaceCopied": "Workspace path copied",
    "nav.pin": "Pin",
    "nav.unpin": "Unpin",
    "nav.delete": "Delete",
    ...
    "messages.loadEarlier": "Load {count} earlier messages",
    ...
    "process.trailCount": "{n} steps",
    "activity.title": "Work log",
    ...
    "activity.stepsCompleted": "{n} completed",
    "activity.hideCompleted": "Hide completed",
    "activity.waiting": "Waiting for tools…",
    "activity.completedClosed": "Completed (connection closed)",
